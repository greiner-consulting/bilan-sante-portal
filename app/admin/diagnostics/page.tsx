    ...
    <main className="min-h-screen bg-[#DCE6EE] px-6 py-8">
      <div className="mx-auto max-w-7xl space-y-6">
        <PortalPageHeader
          ...
          description="Cette interface permet à l’administrateur de consulter les sessions, d’ouvrir un diagnostic, de télécharger les exports disponibles et de supprimer un dossier si nécessaire."
