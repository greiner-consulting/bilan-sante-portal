...
const CLARIFICATION_PATTERNS = [
  ...
  "deja repondu",
  "déjà répondu",
  "plus precis sur le constat",
  "plus précis sur le constat",
  "il faut etre plus precis",
  "il faut être plus précis",
  "je ne comprends pas ce qu il y a derriere cette phrase",
  "je ne comprends pas ce qu'il y a derrière cette phrase",
  "c est trop vague",
  "c'est trop vague",
  "c est nebuleux",
  "c'est nébuleux",
  "je ne comprends pas ce qu il y a derriere",
  "je ne comprends pas ce qu'il y a derrière",
];
